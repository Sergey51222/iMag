(() => {
	"use strict";
	/* Checking for webp support, adding the webp or no-webp class to HTML */
	function isWebp() {
		...
		// Adding the class "_webp" or "_no-webp" to HTML
		testWebP((function (support) {
			let className = support === true ? "webp" : "no-webp";
			document.documentElement.classList.add(className);
		}));
	}
	// Getting the hash of the website URL
	function getHash() {
		if (location.hash) return location.hash.replace("#", "");
	}
	// Indicating the hash of the website URL
	function setHash(hash) {
		hash = hash ? `#${hash}` : window.location.href.split("#")[0];
		history.pushState("", "", hash);
	}

	// Auxiliary modules for smooth object expansion and collapse ================================
	...
	// Auxiliary modules for scroll blocking and jumping =====================
	...
	// So much functions by slider Swiper. The next comment is on line 3614 =======================
